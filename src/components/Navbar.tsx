...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex bg-black items-center py-5 fixed top-0 z-20 ${
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="sm:hidden mr-9 sm:mr-0 flex flex-1 justify-end items-center">
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            } p-6 shadow-lg shadow-zinc-500 bg-[#D5FF40] absolute top-20  right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}
          >
